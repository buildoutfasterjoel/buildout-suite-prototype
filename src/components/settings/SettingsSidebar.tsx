...
export const SETTINGS_NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Back Office", href: "back-office", icon: faCalculator },
      { label: "Invoice Defaults", href: "invoice-defaults", icon: faFileInvoice },
      { label: "QuickBooks", href: "quickbooks", icon: faCircleDollar },
    ],
  },
  {
    label: "Marketing",
    items: [
      ...
      { label: "Document Defaults", href: "document-defaults", icon: faFileLines },
