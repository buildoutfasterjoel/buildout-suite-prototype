 ...
 * 'generated' (a toast fires and the row shows "Save underwriting") → placement
 * modal → "Review". Generation finishes async: it never auto-opens the
 * placement modal, so the broker's overview is never hijacked — they save the
            ...
            <div className="text-muted fs-small">
              {phase === "ready"
                ? placedName
                  ...
                  : "Generated by AI"
                : phase === "generated"
                  ? "Underwriting ready — save it to a document."
