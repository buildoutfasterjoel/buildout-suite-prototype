 ...
 * site. What it cannot reach is a control that isn't a native element: Blueprint
 * renders `Switch` as a `<span role="switch">`, and a span has no disabled state
 * for the fieldset to inherit down to. Left alone it stays live inside a locked
 * form and still toggles.
 *
 * So the fieldset stays the mechanism and this covers its one blind spot. Any
